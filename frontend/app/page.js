...
export default function Home() {
  ...
  return (
    ...
    <StarsBackground className="absolute inset-0 w-full h-full -z-10 pointer-events-none" />
    ...
    <section className="relative z-10 container px-4 py-10 mx-auto lg:h-128 lg:flex lg:items-center">
          <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
            <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 text-white drop-shadow-lg md:text-4xl">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-50 drop-shadow">
          ...
          <div className="w-full mt-4 lg:mt-0 lg:w-1/2 relative z-10">
            <img
              src="/left.png"
              alt="hero visual"
              className="w-auto h-auto max-w-md mx-auto drop-shadow-xl"
            />
          </div>
        </section>
      </div>
